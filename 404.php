...
<?php get_header();?>
          ...
          <div class="row align-items-md-center gy-4">
            <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-end text-center">
              ...
              <div class="position-relative zindex-5">
                ...
                <div class="pt-3"><a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="<?php home_url();?>">صفحه اصلی</a><a class="btn btn-lg btn-outline-light w-sm-auto w-100 mb-3" href="<?php home_url();?>">صفحه پشتیبانی</a></div>
              </div>
            </div>
            <div class="col-lg-6 offset-lg-2 order-lg-2 order-1">
              <div class="ratio ratio-1x1 mx-auto" style="max-width: 636px;">
                <lottie-player src="https://finder.createx.studio/json/animation-real-estate-404.json" background="transparent.html" speed="1" loop autoplay></lottie-player>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/vendor/lottiefiles/lottie-player/dist/lottie-player.js"></script>
    <!-- Main theme script-->
    <script src="<?php echo get_template_directory_uri(); ?>/js/theme.min.js"></script>
  </body>

<!-- Mirrored from finder.createx.studio/real-estate-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Dec 2021 07:50:12 GMT -->
</html>