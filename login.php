              ...
              <div class="row mx-0 align-items-center">
               ...
               <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                  <div class="d-flex align-items-center py-3 mb-3">
					...
					<form class="needs-validation" action="<?php echo get_option('home'); ?>/wp-login.php" method="post">
					<div class="mb-4">
   					<input	class="form-control" type="text" name="log" id="log" value="<?php echo wp_specialchars(stripslashes($user_login), 1) ?>" size="20" placeholder="نام کاربری خود را وارد کنید" />
					   </div>
					   <div class="mb-4">
   					<input	class="form-control" type="password" name="pwd" id="pwd" size="20" placeholder="پسوورد خود را وارد کنید" />
					   </div>
      				...
      				value="<?php echo $_SERVER['REQUEST_URI']; ?>" />
   					...
   					<input class="btn btn-primary btn-lg w-100" type="submit" name="submit" value="ورود" class="button" />
